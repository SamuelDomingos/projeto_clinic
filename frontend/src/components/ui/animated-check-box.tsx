    ...
    <>
      ...
      >
        ...
        <div className="relative w-full h-full neon-checkbox__frame">
          <div
            className={`absolute inset-0 bg-black/80 rounded border-2 transition-all duration-400 neon-checkbox__box ${
              isChecked ? "border-[var(--primary)] bg-[rgba(0,255,170,0.1)]" : "border-[var(--primary-dark)]"
            }`}
          >
            ...
            <div
              className={`absolute -inset-0.5 rounded-md bg-[var(--primary)] blur-md transition-opacity duration-400 neon-checkbox__glow ${
              ...
              {[...Array(4)].map((_, i) => (
                <span
                  ...
                  className={`absolute w-10 h-px bg-[var(--primary)] transition-opacity duration-400 ${
                    ...
                    i === 0
                      ? "top-0 left-[-100%] animate-[borderFlow1_2s_linear_infinite]"
                      : i === 1
                        ? "top-[-100%] right-0 w-px h-10 animate-[borderFlow2_2s_linear_infinite]"
                        : i === 2
                          ? "bottom-0 right-[-100%] animate-[borderFlow3_2s_linear_infinite]"
